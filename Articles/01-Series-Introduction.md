# Introducing the Series - A proactive approach to Cloud Security with Microsoft Defender for Cloud

In today’s modern IT landscape, Security shouldn’t be treated as a separate concern — it needs to be part of everyone’s mindset, from IT professionals to business stakeholders. 
Whenever a new initiative kicks off in your organization, Security should be built in from the very beginning.
